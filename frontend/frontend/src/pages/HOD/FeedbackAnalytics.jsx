...
import { ChevronRight, GraduationCap, Calendar, BookOpen, BarChart3 } from 'lucide-react';
...
const FeedbackAnalytics = () => {
  ...
  const batches = {
    'B.Tech': [
      { id: 1, name: '2025-2029', year: 1, regulation: ['R23'], hasData: true },
      { id: 2, name: '2024-2028', year: 2, regulation: ['R23'], hasData: true },
      { id: 3, name: '2023-2027', year: 3, regulation: ['R23', 'R20'], hasData: true },
      { id: 4, name: '2022-2026', year: 4, regulation: ['R20'], hasData: true }
    ],
    'M.Tech': [
      { id: 5, name: '2025-2027', year: 1, regulation: ['R19'], hasData: false },
      { id: 6, name: '2024-2026', year: 2, regulation: ['R19'], hasData: true }
    ]
  };
  ...
  const handleRegulationSelect = (regulation) => {
    ...
    navigate('/hod/feedback-analytics/semesters', { 
      state: { 
        batch: selectedBatch, 
        regulation,
        hodInfo 
  ...
  return (
    <div className="min-h-screen p-4 sm:p-6">
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="mb-6">
        ...
        <p className="text-sm text-gray-600 mt-1">View detailed feedback analytics and reports</p>
      </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {selectedBatch.regulation.map((reg, index) => (
              <motion.button
                ...
                className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl border-2 border-blue-200 hover:border-blue-500 p-8 text-center transition-all hover:shadow-lg group"
              >
